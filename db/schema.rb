...
ActiveRecord::Schema.define(version: 2021_05_19_110858) do
  ...
  create_table "patient_physicians", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["patient_id"], name: "index_patient_physicians_on_patient_id"
    t.index ["physician_id"], name: "index_patient_physicians_on_physician_id"
  end
